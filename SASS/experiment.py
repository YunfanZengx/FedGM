...
"""
# Use FedAvg with SASS (adaptive optimizer)
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/experiment.py --num_clients 5 --global_rounds 50 --local_epochs 1 --dist case3 --agg_method gm --local_opt sass

# Use FedGM (geometric median aggregation) with SGD (fixed LR)
# python /home/local/ASURITE/yzeng88/fedSASS/SASS/experiment.py --num_clients 5 --global_rounds 50 --local_epochs 1 --dist case2 --lr 0.01 --agg_method avg --local_opt sgd
...
def local_train_sass(model, train_dataset, device, optimizer, cid,
    ...
    """
    Train one client locally using SASS. Logs training loss per mini‐batch and test loss per epoch.
    """
    model.train()
    model.to(device)
...
def main():
    ...
    # 4) Create a local optimizer per client
    client_optimizers = []
